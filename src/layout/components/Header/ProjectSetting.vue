<template>
  <n-drawer v-model:show="isDrawer" :width="width" :placement="placement">
    <n-drawer-content :title="title" :native-scrollbar="false">
      <div class="drawer">
        <n-divider title-placement="center">Тема</n-divider>
        ...
        <div class="justify-center drawer-setting-item dark-switch">
          <n-tooltip placement="bottom">
            ...
            <span>{{ designStore.darkTheme ? 'Тёмная' : 'Светлая' }} тема</span>
          </n-tooltip>
        </div>

        <n-divider title-placement="center">Цвет темы</n-divider>
        ...
        <n-divider title-placement="center">Режим навигации</n-divider>
        ...
        <div class="drawer-setting-item align-items-top">
          ...
          <div class="drawer-setting-item-style">
            <n-tooltip placement="top">
              ...
              <span>Смешанное меню</span>
            </n-tooltip>
            <n-badge dot color="#19be6b" v-show="settingStore.navMode === 'horizontal-mix'" />
          </div>
        </div>

        <n-divider title-placement="center">Стиль навигации</n-divider>
        ...
        <div class="drawer-setting-item align-items-top">
          ...
          <div class="drawer-setting-item-style">
            <n-tooltip placement="top">
              ...
              <span>Тёмный хедер</span>
            </n-tooltip>
            <n-badge dot color="#19be6b" v-if="settingStore.navTheme === 'header-dark'" />
          </div>
        </div>
        <n-divider title-placement="center">Функции</n-divider>

        <div class="drawer-setting-item">
          <div class="drawer-setting-item-title"> Разделять меню </div>
        ...
        <div class="drawer-setting-item">
          <div class="drawer-setting-item-title"> Фикс. хедер </div>
          <div class="drawer-setting-item-action">
        ...
        <div class="drawer-setting-item">
          <div class="drawer-setting-item-title"> Фикс. вкладки </div>
          <div class="drawer-setting-item-action">
            <n-switch v-model:value="settingStore.multiTabsSetting.fixed" />
          </div>
        </div>

        <n-divider title-placement="center">Отображение</n-divider>

        <div class="drawer-setting-item">
          <div class="drawer-setting-item-title"> Кнопка перезагрузки </div>
          <div class="drawer-setting-item-action">
        ...
        <div class="drawer-setting-item">
          <div class="drawer-setting-item-title"> Хлебные крошки </div>
          <div class="drawer-setting-item-action">
        ...
        <div class="drawer-setting-item">
          <div class="drawer-setting-item-title"> Иконки в крошках </div>
          <div class="drawer-setting-item-action">
        ...
        <div class="drawer-setting-item">
          <div class="drawer-setting-item-title"> Показывать вкладки </div>
          <div class="drawer-setting-item-action">
        ...
        <n-divider title-placement="center">Анимация</n-divider>

        <div class="drawer-setting-item">
          <div class="drawer-setting-item-title"> Вкл. анимацию </div>
          <div class="drawer-setting-item-action">
        ...
        <div class="drawer-setting-item">
          <div class="drawer-setting-item-title"> Тип анимации </div>
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      const state = reactive({
        ...
        isDrawer: false,
        placement: 'right',
        alertText: 'Тут предпросмотр, полные настройки в projectSetting.ts.',
